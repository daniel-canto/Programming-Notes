...
Outro ponto que se destaca sobre as interfaces, é que uma classe pode implementar vários contratos, o que não acontece com a [[Classes, Objetos e Instâncias#O que é uma classe abstrata?|classe abstrata]].
* Imagem:
